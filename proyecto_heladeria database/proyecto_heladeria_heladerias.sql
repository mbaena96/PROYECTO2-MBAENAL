...
--
-- Table structure for table `heladerias`
--
...
CREATE TABLE `heladerias` (
  ...
  `venta_dia` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `heladerias`
--

LOCK TABLES `heladerias` WRITE;
/*!40000 ALTER TABLE `heladerias` DISABLE KEYS */;
INSERT INTO `heladerias` VALUES (1,'Heladería Don Juan',77000);
